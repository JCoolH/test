...
function online_show() {
	if(document.getElementById("ZHTXOnlineView")){
		new scrollx({id:"ZHTXOnlineView",l:{$_divL},t:{$_divT},f:1,m:{$_divM}});
	}
}
	document.write('<link href="{$js_path}/static/js_plugins/online/{$_cfg_online_style}.css" rel="stylesheet" type="text/css" />');
	document.write('<div id="ZHTXOnlineView" class="zhtx_online_view">');
