...
class CartAction extends Action {
	...
	public function add() {
		...
		//del_cookie(array('name' => 'zhtx_cart'));exit();//清空删除购物车
		$old_cartinfo = get_cookie('zhtx_cart');
	...
	public function show() {
		...
		if(isset($_SESSION['USER_AUTH_KEY']) && $basket['user_id']==0){//用户登录后,购物cookie user_ID为0时，更新到新登录的cookie
			...
			set_cookie(array('name' => 'zhtx_cart', 'value' =>$cartinfo ));
