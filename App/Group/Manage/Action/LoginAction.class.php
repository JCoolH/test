...
class LoginAction extends Action{
	...
	public function login(){
		...
		session('zhtx_adm_username', $user['username']);
		session('zhtx_adm_roleid', intval($user['roleid']));
		session('zhtx_adm_logintime', date('Y-m-d H:i:s', $user['logintime']));
		session('zhtx_adm_loginip', $user['loginip']);
