...
.zhtx_box{background:#e9f8ff;width:400px;height:auto;border:solid 7px #57c0ff;border-radius:5px;padding:0px;position: absolute;left: 50%;top: 50%;overflow: hidden;display:block;margin:-150px 0 0 -200px;}
.zhtx_box .zhtx_box_content{padding:20px;}
.zhtx_box .title{font-size:16px;font-weight:bold;height: 36px; line-height: 36px; padding: 0px 0px 0px 10px; overflow:hidden;  color:#ffffff;background-color:#2b9ee4;
...
<div>
	...
	<div class="zhtx_box">
		<div class="title">ZHTXCMS 提示<span class="space30"></span><span class="space"></span><span class="space"></span><span class="space"></span></div>
		<div class="zhtx_box_content">	
