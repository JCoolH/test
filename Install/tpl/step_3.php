<?php if (!defined('ZHTXCMS_INSTALL')) exit('Access Denied!')?>
	...
	<div class="main">
		...
		<table class="table1">
			...
			<tr>
				...
				<td><input type="text" class="text" value="zhtxcms" name="DB_NAME" /></td>
				<td><?php echo $lang['install_mysql_name_intro']; ?></td>
			</tr>
			<tr>
				<td><font class="red">*</font>&nbsp;<?php echo $lang['install_mysql_prefix']; ?>：</td>
				<td><input type="text" class="text" value="zhtx_" name="DB_PREFIX" /></td>
			...
			<tr>
				...
				<td><input type="text" class="text" value="sczhtx" name="username" /></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td><font class="red">*</font>&nbsp;<?php echo $lang['password']; ?>：</td>
				<td><input type="text" class="text" value="sczhtx9191" name="password" /></td>
