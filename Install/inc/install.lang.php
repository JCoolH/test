<?php
if(!defined('ZHTXCMS_INSTALL')) exit('Access Denied');
$lang = array(
	'install_title' => 'ZHTXCMS 2.0安装向导',
	'install_license' => '纵横天下内容管理系统-安装用户协议',
	'install_is_lock' => '您已成功安装ZHTXCMS，需重新安装请手动删除网站目录下install/install.lock文件', 
	'install_db_error' => '数据库文件无法读取，请检查install/inc/zhtxcms.sql是否存在。',	
